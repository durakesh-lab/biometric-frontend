...
//                       const isSelected = selected.indexOf(branch.id) !== -1;
//                       return (
//                         <TableRow
//                           key={branch.id}
//                           hover
...
//                               anchorEl={anchorEl}
//                               keepMounted
//                               open={openMenu && selectedBranch?.id === branch.id}
...
//                               <MenuItem onClick={() => handleConfirmDelete(selectedBranch?.id)}>Delete</MenuItem>
//                             </Menu>
//                           </TableCell>
//                         </TableRow>
//                       );
...
/>
        ...
        {/* View Branch Modal */}
        {console.log(viewModalOpen,"viewModalOpenviewModalOpen##########")}
        <ViewBranchModal 
          branch={selectedBranchView}
          open={viewModalOpen}
          onClose={() => setViewModalOpen(false)}
