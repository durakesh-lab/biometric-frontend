...
const ViewDepartmentModal = ({employee: department, open, onClose }) => {
        ...
        <Box sx={{
          ...
          <Box sx={{ p: 3 }}>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <Section title="Department Information" icon={<DepartmentIcon color="primary" />}>
                  <FieldRow 
                  ...
                  <FieldRow 
                    ...
                    value={department.parent_dept?.dept_code || "--"} 
                    icon={<ParentDepartmentIcon fontSize="small" />}
                  />
                  <FieldRow 
                    label="Parent Department Name" 
                    value={department.parent_dept?.dept_name || "--"} 
                    icon={<ParentDepartmentIcon fontSize="small" />}
                  />
                </Section>
