          ...
          <Box sx={{ p: 3 }}>
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={6}>
                ...
                <Section title="Personal Information" icon={<ContactIcon color="primary" />}>
                  <FieldRow 
                    label="Aadhaar No." 
                    value={employee.ssn} 
              ...
              <Grid item xs={12} md={6}>
                ...
                <Section title="Contact Details" icon={<ContactIcon color="primary" />}>
                  <FieldRow 
                    label="Office Tel" 
                ...
                <Section title="Device Settings" icon={<SettingsIcon color="primary" />}>
                  <FieldRow 
                ...
                <Section title="App Settings" icon={<AdminIcon color="primary" />}>
                  <FieldRow 
                    label="App Status" 
